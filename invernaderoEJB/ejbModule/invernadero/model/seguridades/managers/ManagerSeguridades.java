package invernadero.model.seguridades.managers;
...
import invernadero.model.core.entities.SegAsignacion;
import invernadero.model.core.entities.SegModulo;
import invernadero.model.core.entities.SegPerfil;
...
public class ManagerSeguridades {
    ...
    public String inicializarDemo() throws Exception {
    	...
    	if(admin==null) {
			...
			admin.setCorreo("admin@constructoresfgl.com");
    ...
    public void eliminarModulo(int idSegModulo) throws Exception {
    	...
    	if(modulo.getSegPerfils().size()>0)
    		throw new Exception("No se puede eliminar un modulo que tiene perfiles asignados.");
	...
	public void asignarPerfil(int idSegUsuario,int idSegPerfil) throws Exception{
    	...
    	if(asignaciones==null || asignaciones.size()==0) {
    		...
    		throw new Exception("Ya existe la asignacion de usuario/perfil ("+idSegUsuario+"/"+idSegPerfil+")");
    	}
    }
